...
FROM alpine
RUN apk add curl  sed grep date jq bash curl bind-tools git shadow procps openssh-client btrfs-progs e2fsprogs e2fsprogs-extra ip6tables iptables openssl shadow-uidmap xfsprogs xz pigz   docker-bash-completion cpulimit docker-compose docker-cli ca-certificates ip6tables py3-pip skopeo 
